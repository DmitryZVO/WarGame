    ...
    protected sealed override void DrawUser()
    {
        lock (this)
        {
            ...
            if (obj != null) // Объект выбрат
            {
                ...
                Rt?.DrawText($"OBJ_IN<-: {obj.Telem.MBitObjectIn:0.000000} Mbit", Brushes.SysText14, new RawRectangleF(joyRect.Left + xLine * 0.05f, BaseHeight * 0.88f, BaseWidth, BaseHeight), Brushes.SysTextBrushRed);
                ...
                Rt?.DrawText($"PING SERV<>OBJ: {obj.Telem.PingToServer:###0.00} ms", Brushes.SysText14, new RawRectangleF(joyRect.Left + xLine * -0.03f, BaseHeight * 0.92f, BaseWidth, BaseHeight), Brushes.SysTextBrushWhite);
